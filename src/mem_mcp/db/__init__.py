...
Public API:
    ...
    init_maint_pool(dsn=None) -> asyncpg.Pool  — call for DDL operations (e.g. plugin schemas)
    close_maint_pool() -> None            — call at shutdown
    get_maint_pool() -> asyncpg.Pool      — accessor; RuntimeError if not initialized
