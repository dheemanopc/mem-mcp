...
class TestDcrEndpointSuccess:
    def test_201_with_rfc7591_response(self) -> None:
        ...
        assert body["scope"] == "https://memsys.dheemantech.in/account.manage https://memsys.dheemantech.in/memory.admin https://memsys.dheemantech.in/memory.read https://memsys.dheemantech.in/memory.write"
